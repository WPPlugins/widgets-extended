...
add_action( 'widgets_init', create_function('', 'return register_widget("WPWERecentPosts");') );

class WPWERecentPosts extends WP_Widget
{
  function WPWERecentPosts()
  {
    $widget_ops = array('classname' => 'WPWERecentPosts', 'description' => 'The most recent posts with thumbnails on your site.' );
    $this->WP_Widget('WPWERecentPosts', 'WPWE - Recent Posts', $widget_ops);
  }
